...
class Hypnos:
    ...
    This class encapsulates the training and evaluation logic for a given model,
    including data loading, loss computation, metric evaluation, and logging.
    ...
    def __init__(self,
        ...
        # Initialize metrics
        self.ssim_metric = SSIM(data_range=1.0, size_average=True).to(device)
        self.msssim_metric = MS_SSIM(data_range=1.0, size_average=True).to(device)

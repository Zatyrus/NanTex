# pyDialogue is a simple wrapper around tkinter's filedialog
# to provide easy-to-use file and directory selection dialogs.
# It includes methods for selecting single or multiple files and directories,
# as well as a save-as dialog with common file type filters.

...
def evaluate():
    ...
    if len(path) == 1:
        ...
        for i, eval_case in enumerate(eval_cases):
            ...
            #start = time()
            #print('their_SSIM')
            results[f'feature_{i}']['SSIM'] = ssim(eval_case[...,0][...,None],eval_case[...,1][...,None], 255)
            #print('their_SSIM', str(-start+time()))
            results[f'feature_{i}']['SSIM_sewar'] = sfr.ssim(eval_case[...,0][...,None],eval_case[...,1][...,None], MAX = 255)
            #print('sewar_SSIM', str(-start+time()))
            results[f'feature_{i}']['MSSSIM'] = sfr.msssim(eval_case[...,0][...,None],eval_case[...,1][...,None], MAX = 255)
            #print('sewar_MSSSIM', str(-start+time()))
            results[f'feature_{i}']['FSIM'] = fsim(eval_case[...,0][...,None],eval_case[...,1][...,None])
...
def bulk_eval(in_path, out_path):
    ...
    for i, eval_case in enumerate(eval_cases):
        results[f'feature_{i}']['PSNR'] = psnr(eval_case[...,0][...,None],eval_case[...,1][...,None], 255)
        results[f'feature_{i}']['SSIM'] = ssim(eval_case[...,0][...,None],eval_case[...,1][...,None], 255)
        results[f'feature_{i}']['MSSSIM'] = sfr.msssim(eval_case[...,0][...,None],eval_case[...,1][...,None], MAX = 255)
    
    with open(f"{out_path}/{os.path.basename(in_path)[:-8]}_eval_dump.pickle", 'wb') as current:
